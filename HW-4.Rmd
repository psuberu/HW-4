...
Type `getwd()` in the R console to get the directory path to your `HW-4` folder
and replace `directory_name` with the resulting 

```{r}
directory_name <- "/Users/aykim/Documents/Teaching/MATH216/HW/HW-4"
shapefile_name <- 
  paste(directory_name, "/VT_census_tracts/tl_2015_50_tract.shp", sep="")
